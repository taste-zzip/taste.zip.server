...
public record WorldcupResponseDto(
    ...
    public record AccountMapping(
        ...
        public static WorldcupResponseDto.AccountMapping of(List<AccountVideoMapping> mappingList) {
            ...
            return WorldcupResponseDto.AccountMapping.builder()
                    .LIKE(like)
                    .TROPHY(trophy)
                    .STAR(star)
                    .build();
    ...
    public static WorldcupResponseDto from(Video video, com.google.api.services.youtube.model.VideoSnippet snippet, com.google.api.services.youtube.model.VideoStatistics statistics, WorldcupResponseDto.AccountMapping mapping) {
